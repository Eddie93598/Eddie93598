Google is committed to protecting the privacy and security of over 2.5 billion
...
This file shows the percentage of installs coming from PHAs using a rolling 12-month rate on
Google Play.

percentage-of-pha-installs-by-top-countries.csv

This file shows the percentage of installs coming from PHAs using a rolling
12-month rate on Google Play by countries. The countries listed represent the
top 10 countries with the highest volume of Android installs in the first day
of current reporting year.
